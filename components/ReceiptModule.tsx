           ...
           <div className="relative z-10 flex flex-col flex-1 m-[28px] bg-white">
               ...
               <div className="px-10 flex-1 flex flex-col relative py-8">
                   ...
                   <div className="flex justify-between items-end mt-16 px-6">
                       ...
                       <div className="text-center relative">{config.stamp && <img src={config.stamp} className="w-32 opacity-90 mix-blend-multiply p-2" />}<p className="text-xs font-bold text-gray-400 mb-2 uppercase">الختم</p></div>
